...
function processRow(indent, data, isPropertyContent){
  var indent = "";
...
function SetTab(){
  var select = document.getElementById('TabSize');
  window.TAB = concatString(parseInt(select.options[select.selectedIndex].value), window.SINGLE_TAB);
}
